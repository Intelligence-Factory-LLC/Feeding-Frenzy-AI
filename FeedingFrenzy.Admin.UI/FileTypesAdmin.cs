...
{
	public class FileTypesAdmin : JsonWs
	{
		public const string KSCRIPT_FILE = @"FileTypes\FileTypesAdmin.ks.html";
		...
		public static string GetDetails(string FileTypeID
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"FileTypesAdmin.GetDetails", 
		...
		)
		{
			...
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"FileTypesAdmin.GetDropDownWithNull", 
				new List<string> {  }
			);
		}
		...
		public static string GetEdit(string FileTypeID
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"FileTypesAdmin.GetEdit", 
				new List<string> { FileTypeID,  }
			);
		}
		...
		public static string GetGridHtmlInternal(string FileTypes
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"FileTypesAdmin.GetGridHtmlInternal", 
				new List<string> { FileTypes,  }
			);
		}
