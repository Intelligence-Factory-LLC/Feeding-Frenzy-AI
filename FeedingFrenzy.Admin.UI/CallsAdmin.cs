...
{
	public class CallsAdmin : JsonWs
	{
		public const string KSCRIPT_FILE = @"Calls\CallsAdmin.ks.html";
		...
		public static string GetDetails(string CallID
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"CallsAdmin.GetDetails", 
				new List<string> { CallID,  }
			);
		}
		...
		)
		{
			...
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"CallsAdmin.GetDropDownWithNull", 
				new List<string> {  }
			);
		}
		...
		public static string GetEdit(string CallID
		)
		{
			Initialize();
		...
		public static string GetGridHtmlInternal(string Calls
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"CallsAdmin.GetGridHtmlInternal", 
				new List<string> { Calls,  }
			);
		}
