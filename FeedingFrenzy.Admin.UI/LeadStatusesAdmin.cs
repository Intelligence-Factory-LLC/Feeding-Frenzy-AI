...
{
	public class LeadStatusesAdmin : JsonWs
	{
		public const string KSCRIPT_FILE = @"LeadStatuses\LeadStatusesAdmin.ks.html";
		...
		public static string GetDetails(string LeadStatusID
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"LeadStatusesAdmin.GetDetails", 
		...
		public static string GetEdit(string LeadStatusID
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"LeadStatusesAdmin.GetEdit", 
				new List<string> { LeadStatusID,  }
			);
		}
		...
		)
		{
			...
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"LeadStatusesAdmin.GetGridCount", 
