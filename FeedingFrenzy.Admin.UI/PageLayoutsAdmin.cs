...
{
	public class PageLayoutsAdmin : JsonWs
	{
		public const string KSCRIPT_FILE = @"PageLayouts\PageLayoutsAdmin.ks.html";
		...
		public static string GetDetails(string PageLayoutID
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"PageLayoutsAdmin.GetDetails", 
				new List<string> { PageLayoutID,  }
			);
		}
		...
		public static string GetEdit(string PageLayoutID
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"PageLayoutsAdmin.GetEdit", 
				new List<string> { PageLayoutID,  }
			);
		}
