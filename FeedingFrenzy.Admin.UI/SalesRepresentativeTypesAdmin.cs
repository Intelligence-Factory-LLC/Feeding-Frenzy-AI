...
{
	public class SalesRepresentativeTypesAdmin : JsonWs
	{
		public const string KSCRIPT_FILE = @"SalesRepresentativeTypes\SalesRepresentativeTypesAdmin.ks.html";
		...
		public static string GetDetails(string SalesRepresentativeTypeID
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"SalesRepresentativeTypesAdmin.GetDetails", 
		...
		)
		{
			...
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"SalesRepresentativeTypesAdmin.GetDropDown", 
				new List<string> {  }
			);
		}
		...
		public static string GetEdit(string SalesRepresentativeTypeID
		)
		{
			Initialize();
			
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"SalesRepresentativeTypesAdmin.GetEdit", 
				new List<string> { SalesRepresentativeTypeID,  }
			);
		}
		...
		)
		{
			...
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"SalesRepresentativeTypesAdmin.GetGrid", 
				new List<string> {  }
			);
		}
		...
		)
		{
			...
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"SalesRepresentativeTypesAdmin.GetGridCount", 
		...
		)
		{
			...
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"SalesRepresentativeTypesAdmin.GetGridHtml", 
				new List<string> {  }
			);
		}
		...
		)
		{
			...
			return RooTraxState.kScriptControl.EvaluateFunctionN(
				"SalesRepresentativeTypesAdmin.GetInsert", 
				new List<string> {  }
			);
		}
